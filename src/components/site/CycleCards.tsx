        ...
        return (
          <Reveal as="article" key={c.slug} delay={i * 90}>
            <Link to={c.to} className="group block">
              <div
                className={`flex aspect-4/5 w-full items-center justify-center overflow-hidden transition-transform duration-[900ms] ease-out group-hover:scale-[1.03] ${style.className}`}
              >
